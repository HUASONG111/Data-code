...
data_files = {'duration_po4.csv', 'duration_no3.csv', 'duration_sst.csv', 'duration_no3.csv'};
...
for i = 1:length(means)
    ...
    yyaxis right;
    l = plot(xPositions, nanRatios, 'o-', 'LineWidth', 2, 'MarkerSize', 4, 'MarkerFaceColor', [227/255, 113/255, 110/255]);
